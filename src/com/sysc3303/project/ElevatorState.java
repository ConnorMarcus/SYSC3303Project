...
public class ElevatorState {
	...
	public void handleRequest(Elevator elevator, ElevatorEvent.Direction direction, int requestedFloor) {
		...
		sleepWhileMoving(Math.abs(requestedFloor - elevator.getCurrentFloor())); // sleep for a certain time to simulate
																					// moving between floors
	}

	/**
	 * Sleeps for an amount of time corresponding to the distance the elevator is moving
	 * 
